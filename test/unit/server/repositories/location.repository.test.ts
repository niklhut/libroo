...
describe.each<AtomicMode>(['d1-batch', 'selfhost-transaction'])('LocationRepository atomic mutations (%s)', (mode) => {
  ...
  beforeEach(async () => {
    ...
    for (const migrationFile of ['0000_initial_beta.sql', '0001_add_terms_acceptance.sql', '0002_prevent_location_delete_cascade.sql', '0003_add_library_state.sql', '0006_huge_tiger_shark.sql', '0008_brave_saracen.sql', '0012_imported_book_enrichment.sql']) {
